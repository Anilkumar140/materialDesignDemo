...
@Component({
  selector: 'app-tablerow-grouping',
  templateUrl: './tablerow-grouping.component.html',
  styleUrls: ['./tablerow-grouping.component.css']
})
export class TablerowGroupingComponent implements OnInit {
